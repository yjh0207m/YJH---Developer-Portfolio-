...
VALUES (1, '군필', '육군', '병장', '통신', '2020-10-13', '2022-04-12');

-- ─── 4. certifications ───────────────────────────────────────
INSERT INTO certifications (name, issuer, issued_date, category, is_in_progress, order_num) VALUES
('실기교사(음악)교원자격증', '교육부',           '2023-02-01', '교원자격',   0, 3),
('1종보통운전면허',          '경찰청',           '2023-03-01', '운전면허',   0, 4),
('프로그래밍기능사',         '한국산업인력공단', '2026-04-01', '국가기술자격', 0, 2),
('정보처리산업기사',         '한국산업인력공단', '2026-06-12', '국가기술자격', 0, 1);
...
('수업 경연대회 우수 수업지도안 2위', '2022', '국제예술대학교', NULL, 5),
('수업 경연대회 우수 수업동영상 1위', '2022', '국제예술대학교', NULL, 4);
